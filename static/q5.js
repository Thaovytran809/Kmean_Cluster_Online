d3.json("/customer-data/").then(function(data) {
  ...
  function drawPiePerCluster(containerId, fullData, fieldLabel) {
  ...
  drawPiePerCluster("#kidPieContainer", kidData, "Kidhome");
  drawPiePerCluster("#teenPieContainer", teenData, "Teenhome");
});
